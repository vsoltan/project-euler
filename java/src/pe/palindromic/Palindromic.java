...
public class Palindromic {
		...
		for (int x = 1; x <= maxNDigitNum; x++) {
			for (int y = 1; y <= maxNDigitNum; y++) {
				...
				if (isPalindromic(x_dot_y)) {
					if (res < x_dot_y) {
						System.out.println("Largest palindrom product: " + x_dot_y
								+ ", x=" + x + ", y=" + y);
					}
	...
	public static void main(String[] args) {
		//System.out.println("LargestPalindromProductOfTwo2DigitNumbers: "
		//		+ Palindromic.largestPalindromProductOfTwoNDigitNumbers(2));
		//System.out.println("LargestPalindromProductOfTwo3DigitNumbers: "
		//		+ Palindromic.largestPalindromProductOfTwoNDigitNumbers(3));
		//System.out.println("LargestPalindromProductOfTwo3DigitNumbers: "
		//		+ Palindromic.largestPalindromProductOfTwoNDigitNumbers(4));
		System.out.println("LargestPalindromProductOfTwo3DigitNumbers: "
					+ Palindromic.largestPalindromProductOfTwoNDigitNumbers(5));
